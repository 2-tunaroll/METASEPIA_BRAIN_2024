...
float waveform::calc_angle_sinwave(float amplitude, float wavelength, unsigned long time, int servonum)
{  
...
float waveform::calc_angle_flatwave(float amplitude, float wavelength, unsigned long time)
{  
    // sample the waveform to get height of wave at a calculated point based on servonum 
...
float waveform::calc_angle_standingwave(float amplitude, float wavelength, unsigned long time, int servonum)
{  
    long time2 = time;

    // sample the waveform to get height of wave at a calculated point based on servonum 
    float height1 = amplitude * sin( (2*M_PI/wavelength) * (time + FIN_LENGTH_MM*servonum/(NUM_SERVOS-1)));
    float height2 = amplitude * sin( (2*M_PI/wavelength) * (-time2 + FIN_LENGTH_MM*servonum/(NUM_SERVOS-1)));
...
float waveform::calc_angle_sinandflat(float amplitude, float wavelength, unsigned long time, int servonum)
{
    // sample the waveform to get height of wave at a calculated point based on servonum 
